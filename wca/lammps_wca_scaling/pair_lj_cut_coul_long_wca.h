...
#ifndef LMP_PAIR_LJ_CUT_COUL_LONG_WCA_H
#define LMP_PAIR_LJ_CUT_COUL_LONG_WCA_H

#include "pair.h"

namespace LAMMPS_NS {

class PairLJCutCoulLongWCA : public Pair {

 public:
  PairLJCutCoulLongWCA(class LAMMPS *);
  virtual ~PairLJCutCoulLongWCA();
